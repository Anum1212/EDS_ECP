{{--*/ $approvers = \App\Employee::with('department', 'department.businessUnit', 'divisionsApprover')->whereHas('department.businessUnit.company', function($query) use ($employee){$query->where('companies.group_name', '=', $employee->department->businessUnit->company->group_name);})->get(); /*--}}
