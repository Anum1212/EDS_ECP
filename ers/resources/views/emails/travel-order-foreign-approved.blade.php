                ...
                <div class="content">
                    <table>
                        <tr>
                            <td>
                                <header>
                                <h2>Travel Order Approved by {{ $approvedBy->employee_name }}</h2>
                            </header>
                                <p>Hello <strong>{{ $client->nick_name }}</strong>,</p>
                                <p>{{ $employee->employee_name }} has submitted the travel order.
                                    {{ $approvedBy->employee_name }} has already approved this travel order and it
                                    requires your approval as well in Employee Claim Portal.<br></p>
                                ...
                                <footer>
                                    <p>Please login to <a href="https://hcm44.packagesgroup.com"
                                            style="text-decoration: none">Employee Claim Portal</a> in order to approve
                                        this
                                        travel order.</p><br>
                                </footer>
