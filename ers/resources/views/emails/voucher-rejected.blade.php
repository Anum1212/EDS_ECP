                ...
                <div class="content">
                    <table>
                        <tr>
                            <td>
                                <header>
                                <h2 style="background-color: #FF4961; padding: 13px; text-align: center; color: white">
                                    Voucher Rejected</h2>
                                </header>
                                <p>Hello <strong>{{ $client->nick_name }}</strong>,</p>
                                <p>{{ $employee->employee_name }} has rejected your claim # {{ $voucher->id }} in
                                    Employee Claim Portal.<br></p>
