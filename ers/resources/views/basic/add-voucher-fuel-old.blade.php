                                        ...
                                        <table class="table">
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>{{isset($vehicle->vehicle_number) ? $vehicle->vehicle_number : "ABC-123"}}</td>
                                                    <td class="text-right"><strong>Total Fuel Limit: </strong></td>
                                                    <td>{{$entitlements->total_limit}} Liters</td>
                                                </tr>
                                                <tr>
                                                    <td class="text-right"><strong>Consumed Fuel Limit </strong></td>
                                                    <td>{{$entitlements->consumed_limit}} Liters</td>
                                                    <td class="text-right"><strong>Remaining Fuel Limit </strong></td>
                                                    <td>{{$entitlements->total_limit - $entitlements->consumed_limit}} Liters</td>
                                                </tr>
                                            </tbody>
                                        </table>
                                    </div>
                                                            ...
                                                            @else
                                                                <div class="form-row" id="template-row">
                                                                    ...
                                                                    <div class="form-group col-md-2 mb-2">
                                                                        ...
                                                                        <div class="form-group col-md-1 mb-2">
                                                                            <select class="form-control select-custom" name="official_travel_1" required style="height: 50%;">
                                                                                <option value="Yes">Yes</option>
                                                                                <option value="No">No</option>
                                                                            </select>
                                                                        </div>
