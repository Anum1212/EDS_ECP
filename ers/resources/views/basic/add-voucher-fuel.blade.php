...
@section('body')
                                        ...
                                        <div class="content-body">
                                            <section id="form-control-repeater">
                                                <form action="{{ URL::to($storingURL) }}" method="post" id="voucher-form" enctype="multipart/form-data" onsubmit="return validateForm()">
                                                    ...
                                                    <input type="hidden" name="claimType" id="claimType" value="Fuel">
                                                                        ...
                                                                        <div class="row">
                                                                            ...
                                                                            <tbody>
                                                                                <tr>
                                                                                    ...
                                                                                    <td>{{ isset($employee_sf_data->employee_number) ? $employee_sf_data->employee_number : 'N/A' }}</td>
                                                                                    <td class="text-right"><strong>Name: </strong></td>
                                                                                    <td>{{ isset($employee->employee_name) ? $employee->employee_name : 'N/A' }}</td>
                                                                                </tr>
                                                                                <tr>
                                                                                    <td class="text-right"><strong>Grade: </strong></td>
                                                                                    <td>{{ isset($employee_sf_data->grade) ? $employee_sf_data->grade : 'N/A' }}</td>
                                                                                    <td class="text-right"><strong>Designation: </strong></td>
                                                                                    <td>{{ isset($employee_sf_data->designation) ? $employee_sf_data->designation : 'N/A' }}</td>
                                                                                </tr>
                                                                                <tr>
                                                                                    <td class="text-right"><strong>Business Unit: </strong></td>
                                                                                    <td>{{ isset($employee->department->BusinessUnit->bu_name) ? $employee->department->BusinessUnit->bu_name : 'N/A' }}
                                                                                    </td>
                                                                                    <td class="text-right"><strong>Department: </strong></td>
                                                                                    <td>{{ isset($employee->department->department_name) ? $employee->department->department_name : 'N/A' }}</td>
                                                                                </tr>
                                                                                <tr>
                                                                                    <td class="text-right"><strong>Company: </strong></td>
                                                                                    <td>{{ isset($employee->department->BusinessUnit->company->company_name) ? $employee->department->BusinessUnit->company->company_name : 'N/A' }}
                                                                                    </td>
                                                                                    <td class="text-right"><strong>Cost Center: </strong></td>
                                                                                    <td>{{ isset($employee_sf_data->cost_center) ? $employee_sf_data->cost_center : 'N/A' }}</td>
                                                                                </tr>
                                                                                <tr>
                                                                                    <td class="text-right"><strong>Bank: </strong></td>
                                                                                    <td>{{ isset($employee_sf_data->bank) ? $employee_sf_data->bank : 'N/A' }}</td>
                                                                                    <td class="text-right"><strong>Account Number: </strong></td>
                                                                                    <td>{{ isset($employee_sf_data->account_number) ? $employee_sf_data->account_number : 'N/A' }}</td>
                                                                                </tr>
                                                                                ...
                                                                                <tr>
                                                                                    ...
                                                                                    <td>{{ isset($vehicle->vehicle_number) ? $vehicle->vehicle_number : 'N/A' }}</td>
                                                                                    <td class="text-right"><strong>Total Fuel Limit: </strong></td>
                                                                                    <td>{{ isset($entitlements->total_limit) ? $entitlements->total_limit . ' Liters' : 'N/A' }}</td>
                                                                                </tr>
                                                                                <tr>
                                                                                    <td class="text-right"><strong>Consumed Fuel Limit </strong></td>
                                                                                    <td>{{ isset($entitlements->consumed_limit) ? $entitlements->consumed_limit . ' Liters' : 'N/A' }}</td>
                                                                                    <td class="text-right"><strong>Remaining Fuel Limit </strong></td>
                                                                                    <td>{{ (isset($entitlements->total_limit) && isset($entitlements->consumed_limit)) ? ($entitlements->total_limit - $entitlements->consumed_limit) . ' Liters' : 'N/A' }}
                                                                                    </td>
                                                                                </tr>
                                                                            </tbody>
                                        ...
                                        <!--    @if($photo != null && $photo_mimetype != null)-->
                                        <!--        <img src="data:{{$photo_mimetype}};base64,{{ base64_encode($photo) }}" alt="Profile Image" class="img-fluid rounded-circle" style="width: 250px; height: 250px;">-->
                                        <!--    @else-->
                                            ...
                                            <div class="card-content collapse show">
                                                <div class="card-body">
                                                    <div id="rowContainer">
                                                        ...
                                                        {{--*/ $categories = \App\Category::where('company_id', $employee->department->businessUnit->company->id)->where('category_name', 'LIKE', 'Fuel - Receipts')->get(); /*--}}
                                                        {{-- {{$categories}} --}}
                                                        ...
                                                        <div id="category-form">
                                                            ...
                                                            <div class="label-bar col-md-12">
                                                                ...
                                                                <div class="col-md-1 label">Receipt #<span class="required">*</span></div>
                                                                <div class="col-md-1 label">official Travel<span class="required">*</span></div>
                                                                <div class="col-md-1 label">Amount Paid<span class="required">*</span></div>
                                                                <div class="col-md-1 label">Rate Per Liter<span class="required">*</span></div>
                                                                    ...
                                                                    @foreach($voucher->categoryItems($voucher->id) as $item)
                                                                        ...
                                                                        <div class="form-row">
                                                                            <div class="form-group col-md-2">
                                                                                <select name="category_{{$itemCount}}" id="category_{{$itemCount}}" class="form-control custom-input" style="height: 50%;">
                                                                            ...
                                                                            <div class="form-group col-md-1 mb-2">
                                                                                <input type="text" class="form-control custom-input" name="recipt_number_{{$itemCount}}" id="recipt_number_{{$itemCount}}" required>
                                                                            </div>
                                                                            <div class="form-group col-md-1 mb-2">
                                                                                <select class="form-control select-custom" name="official_travel_{{$itemCount}}" required style="height: 50%;">
                                                                            ...
                                                                            <div class="form-group col-md-1 mb-2">
                                                                                <input type="text" class="form-control custom-input" value="{{$item->amount_paid}}" name="amount_{{$itemCount}}" id="amount_{{$itemCount}}" required>
                                                                            </div>
                                                                            <div class="form-group col-md-1 mb-2">
                                                                                <input type="text" class="form-control custom-input" name="rate_per_litre_{{$itemCount}}" id="rate_per_litre_{{$itemCount}}" required>
                                                                            </div>
                                                                            <div class="form-group col-md-2 mb-2">
                                                                                <select class="form-control select-custom" name="receipt_provided_{{$itemCount}}" required style="height: 50%;">
                                                                        ...
                                                                        <!--    <label for="attachment_{{$itemCount}}" class="attachment-label">-->
                                                                ...
                                                                @else
                                                                    <div class="form-row" id="template-row">
                                                                        ...
                                                                        <div class="form-group col-md-2 mb-2">
                                                                            ...
                                                                            <div class="form-group col-md-1 mb-2">
                                                                                <input type="text" class="form-control custom-input" name="recipt_number_1" id="recipt_number_1" required>
                                                                            </div>
                                                                            <div class="form-group col-md-1 mb-2">
                                                                                <select class="form-control select-custom official-travel-select" name="official_travel_1" required style="height: 50%;">
                                                                                    <option value="Yes">Yes</option>
                                                                            ...
                                                                            <div class="form-group col-md-1 mb-2">
                                                                                <input type="text" class="form-control custom-input" name="rate_per_litre_1" id="rate_per_litre_1" required>
                                                                            </div>
                                                                        <div class="form-group col-md-2 mb-2">
                                                        ...
                                                        @else
                                                            <p>You are not entitled to claim fuel entitlements! </p>
                                                        @endif
                                                    </div>
...
@section('footer')
    ...
    <script>
        let itemCount = 1;
        let currentOfficialTravelSelect = null;
        let confirmClicked = false;
        
        // Function to show modal for official travel confirmation
        function showOfficialTravelModal(select) {
            if (select.value === 'Yes') {
                currentOfficialTravelSelect = select;
                confirmClicked = false;
                $('#officialTravelModal').modal('show');
            }
        }
        
        // Handle modal buttons
        document.getElementById('confirmOfficialTravel').addEventListener('click', function() {
            // User confirmed, keep the "Yes" value
            confirmClicked = true;
            console.log('Confirm clicked, setting confirmClicked to true');
            $('#officialTravelModal').modal('hide');
        });
        
        document.getElementById('cancelOfficialTravel').addEventListener('click', function() {
            // User canceled, set back to "No"
            if (currentOfficialTravelSelect) {
                currentOfficialTravelSelect.value = 'No';
                console.log('Canceled official travel');
            }
            $('#officialTravelModal').modal('hide');
        });
        
        // Also handle modal close event
        $('#officialTravelModal').on('hidden.bs.modal', function () {
            console.log('Modal hidden, confirmClicked =', confirmClicked);
            // Only change to "No" if confirm wasn't clicked
            if (!confirmClicked && currentOfficialTravelSelect) {
                currentOfficialTravelSelect.value = 'No';
                console.log('Setting value to No because confirm was not clicked');
            }
        });
        ...
        document.getElementById('add-row-btn').addEventListener('click', function() {
            ...
            // Add the official travel confirmation for the new row
            const officialTravelSelect = newRow.querySelector('.official-travel-select');
            if (officialTravelSelect) {
                officialTravelSelect.setAttribute('onchange', 'showOfficialTravelModal(this)');
            }
        ...
        // Initialize all existing selects when the document is ready
        document.addEventListener('DOMContentLoaded', function() {
            document.querySelectorAll('.official-travel-select').forEach(select => {
                select.setAttribute('onchange', 'showOfficialTravelModal(this)');
            });
        });
    </script>
    <script>
        ...
        $('body').on('change','select.voucherCategory', function(evt){
            ...
            if(category == 'Fuel - Mileage (within city)' || category == 'Fuel - Mileage (out of city)'){
                ...
                var mode_of_travel = $(this).closest('div.form-row').find("select[name^='official_travel_']").val();
        ...
        }).on('change', "select[name^='official_travel_']",function(){
            var category = $('#'+$(this).closest('div.card').data('parent')+' option:selected').text();
            if(category == 'Fuel - Mileage (within city)' || category == 'Fuel - Mileage (out of city)'){
                var totalAmountContainer = $('#total_'+$(this).closest('div.card').data('parent'));
...
<div class="modal fade" id="officialTravelModal" tabindex="-1" role="dialog" aria-labelledby="officialTravelModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="officialTravelModalLabel">Confirm Official Travel</h5>
        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
          <span aria-hidden="true">&times;</span>
        </button>
      </div>
      <div class="modal-body">
        Please confirm this is an official travel.
      </div>
      <div class="modal-footer">
        <button type="button" class="btn btn-secondary" id="cancelOfficialTravel">Cancel</button>
        <button type="button" class="btn btn-primary" id="confirmOfficialTravel">Confirm</button>
      </div>
    </div>
  </div>
</div>
