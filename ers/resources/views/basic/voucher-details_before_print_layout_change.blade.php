        ...
        <div id="leftContentPanel" class="card col-12 col-lg-8 mr-5">
            ...
            <div class="card-body">
                <div class="col-12 w-100 overflow-auto">
                    <table class="table">
                        <tbody>
                            <!--<h5 class="text-primary">ID: {{ $voucher->id }}</h5>-->
                            <!--<tr>-->
                            <!--    <td class="text-right"><strong>ID: </strong></td>-->
                            <!--    <td colspan="3">{{ $voucher->id }}</td>-->
                            <!--</tr>-->
                            ...
                            <tr>
                                ...
                                <td>{{ isset($employee_sf_data->line_manager->employee->employee_name) ? $employee_sf_data->line_manager->employee->employee_name : 'Not Found' }}</td>
                                <td class="text-right"><strong>Business Unit Approver: </strong></td>
                                <td>{{ isset($employee_sf_data->BusinessUnit->bu_head->employee->employee_name) ? $employee_sf_data->BusinessUnit->bu_head->employee->employee_name : 'Not Found' }}</td>
                            </tr>
                        </tbody>
                    </table>
                </div>
                ...
                @else
                    ...
                    <hr>
                    @if ($voucher->status)
                        <button type="button" class="btn btn-sm btn-secondary dont-print" onclick="printDetails()"><i
                                class="la la-print"></i>
                            Print</button>
