...
<div class="content-body"> 
    <section id="form-control-repeater">
        <form action="{{URL::to($storingURL)}}" method="post" id="voucher-form">
                            ...
                            <div class="card-body">
                                <div class="row">
                                        ...
                                        <table class="table">
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>{{$employee->department->BusinessUnit->company->company_name}}</td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>{{$employee_sf_data->line_manager->employee->employee_name}}</td>
                                                    <td class="text-right"><strong>Business Unit Approver: </strong></td>
                                                    <td>{{$employee_sf_data->BusinessUnit->bu_head->employee->employee_name}}</td>
                                                </tr>
                                            </tbody>
                                        </table>
                                    </div>
                                    ...
                                    <div class="col-md-4 text-center">
                                        <img src="{{asset('assets/img/user-placeholder-removebg.png')}}" alt="Profile Image" class="img-fluid rounded-circle" style="width: 250px; height: 250px;">
    ...
    ->where(function ($query) {
        $query->where('category_name', 'Local - DA')
              ->orWhere('category_name', 'Foreign - DA')
              ->orWhere('category_name', 'Local - DA (via Air)');
    })
    ->get();
/*--}}
                                                    <div id="category-form">
                                                        ...
                                                        <div class="label-bar col-md-12">
                                                            ...
                                                            <div class="col-md-1 label">Purpose<span class="required">*</span></div>
                                                            <div class="col-md-1 label" id="personal_days_title">Personal Days<span>*</span></div>
                                                            <div class="col-md-2 label" id="accomodation_title">Type of Accommodation<span>*</span></div>
                                                            <div class="col-md-3 label" id="ta_title">Travel Order<span>*</span></div>
                                                            <div class="col-md-2 label" id="from_title" style="display: none">From<span>*</span></div>
                                                            <div class="col-md-2 label" id="to_title" style="display: none">To<span>*</span></div>
                                                            <div class="col-md-2 label" id="t_accomodation_title" style="display: none">Type of Accomodation<span>*</span></div>
                                                        </div>
                                                        ...
                                                        <div id="form-rows">
                                                                ...
                                                                @foreach($voucher->categoryItems($voucher->id) as $item)
                                                                    ...
                                                                    <div class="form-row">
                                                                        ...
                                                                        <div class="form-group col-md-2 mb-2">
                                                                            ...
                                                                            <input type="text" class="form-control custom-input date-range-picker" name="date_range_{{$itemCount}}" 
                                                                                   id="date_range_{{$itemCount}}" 
                                                                                   value="{{ date('Y-m-d H:i', strtotime($item->date_from)) . ' - ' . date('Y-m-d H:i', strtotime($item->date_to)) }}" 
                                                                                   placeholder="YYYY-MM-DD HH:MM - YYYY-MM-DD HH:MM" required>
                                                                        </div>
                                                                        <div class="form-group col-md-1 mb-2">
                                                                            <input type="text" class="form-control custom-input" name="purpose_{{$itemCount}}" id="purpose_{{$itemCount}}" value="{{$item->description}}" required>
                                                                        </div>
                                                                        <div class="form-group col-md-1 mb-2" id="personal_days_bar_{{$itemCount}}">
                                                                            <input type="text" class="form-control custom-input" name="personal_days_{{$itemCount}}" id="personal_days_{{$itemCount}}" value="{{$item->description}}" required>
                                                                        </div>
                                                                        <div class="form-group col-md-2 mb-2" id="accomodation_food_bar_{{$itemCount}}">
                                                                        ...
                                                                        <!-- Travel Order dropdown for specific categories -->
                                                                        <div class="form-row travel-order-row" id="travel-order-row-{{$itemCount}}">
                                                                        <div class="form-group col-md-3" id="ta_bar_{{$itemCount}}">
                                                                            <select id="travel_order_{{$itemCount}}" name="travel_order_{{$itemCount}}" class="form-control custom-input" style="
                                                                            height: 35%;
                                                                            ">
                                                                                @foreach($employee->approvedUnusedTravelOrders as $travelOrder)
                                                                                <option value="{{$travelOrder->id}}">
                                                                                    {{'Order # '.$travelOrder->id.' of '.'PKR - '.$travelOrder->totalAmount($travelOrder->id).' for'}}
                                                                                        @foreach($travelOrder->VoucherItems as $item)
                                                                        ...
                                                                        <div class="form-group col-md-3 mb-2" id="from_bar_{{$itemCount}}">
                                                                            <input type="text" class="form-control custom-input" name="from_{{$itemCount}}" id="from_{{$itemCount}}" value="{{$item->description}}" style="display: none" required>
                                                                        </div>                                                                        
                                                                        <div class="form-group col-md-3 mb-2" id="to_bar_{{$itemCount}}">
                                                                            <input type="text" class="form-control custom-input" name="to_{{$itemCount}}" id="to_{{$itemCount}}" value="{{$item->description}}" style="display: none" required>
                                                                        </div> 
                                                                        
                                                                        <div class="form-group col-md-2 mb-2" id="t_accomodation_bar_{{$itemCoumt}}"  style="display: none">
                                                                            <select class="form-control select-custom" name="type_of_accomodation_1" style="height: 50%;">
                                                                                <option></option>
                                                            ...
                                                            @else
                                                                <div class="form-row" id="template-row">
                                                                    ...
                                                                    <div class="form-group col-md-1 mb-2" id="personal_days_bar_1">
                                                                        <input type="text" class="form-control custom-input" name="personal_days_1" id="personal_days_1" value="0" required>
                                                                    </div>
                                                                    <div class="form-group col-md-2 mb-2" id="accomodation_food_bar_1">
                                                                    ...
                                                                    <!-- Travel Order dropdown for specific categories -->
                                                                    <div class="form-group col-md-3" id="ta_bar_1">
                                                                            <select id="travel_order_1" name="travel_order_1" class="form-control custom-input" style="
                                                                            height: 50%;
                                                                        ">
                                                                                @foreach($employee->approvedUnusedTravelOrders as $travelOrder)
                                                                                <option value="{{$travelOrder->id}}">
                                                                    ...
                                                                    <div class="form-group col-md-2 mb-2" id="from_bar_1" style="display: none">
                                                                        <input type="text" class="form-control custom-input" name="from_1" id="from_1" value="From" style="display: none" required>
                                                                    </div>                                                                        
                                                                    <div class="form-group col-md-2 mb-2" id="to_bar_1" style="display: none">
                                                                        <input type="text" class="form-control custom-input" name="to_1" id="to_1" value="To" style="display: none" required>
                                                                    </div>
                                                                    <div class="form-group col-md-2 mb-2" id="t_accomodation_bar_1" style="display: none">
                                                                        <select class="form-control select-custom" name="type_of_accomodation_1" style="height: 50%;">
                                                                            <option></option>
                                                                            <option value="yes">Yes</option>
                                                                            <option value="no">No</option>
...
@section('footer')
    ...
    <script>
        function checkCategory(selectElement) {
            ...
            const travelOrderRow = document.getElementById(`travel_order_${rowIndex}`);
            const accommodationRow = document.querySelector(`[name="accomodation_food_${rowIndex}"]`).closest('.form-group');
            const personalDaysRow = document.getElementById(`personal_days_${rowIndex}`);
            const travelOrdertitle = document.getElementById(`ta_title`);
            const accomodationTitle = document.getElementById("accomodation_title");
            const personalDaysTitle = document.getElementById("personal_days_title");
            const fromTitle = document.getElementById("from_title");
            const toTitle = document.getElementById("to_title");
            const fromRow = document.getElementById(`from_${rowIndex}`);
            const toRow = document.getElementById(`to_${rowIndex}`);
            const fromBar = document.getElementById(`from_bar_${rowIndex}`);
            const toBar = document.getElementById(`to_bar_${rowIndex}`);
            const accomodationBar = document.getElementById(`accomodation_food_bar_${rowIndex}`);
            const TABar = document.getElementById(`ta_bar_${rowIndex}`);
            const personalDaysBar = document.getElementById(`personal_days_bar_${rowIndex}`);   
            const t_accomodationTitle = document.getElementById(`t_accomodation_title`);
            const t_accomodationBar = document.getElementById(`t_accomodation_bar_${rowIndex}`);
            
            // console.log(travelOrderRow);
            // console.log(accommodationRow);
            // Categories requiring Travel Order and Accommodation
            const travelOrderCategories = ['Local - DA (via Air)', 'Foreign - DA'];
            
            if (categoryName === 'Local - DA') {
                travelOrderRow.style.display = 'none';
                accommodationRow.style.display = 'none';
                personalDaysRow.style.display = 'none';
                accomodationBar.style.display = 'none';
                TABar.style.display = 'none';
                personalDaysBar.style.display = 'none';
                
                fromRow.style.display = 'block';
                toRow.style.display = 'block';
                fromBar.style.display = 'block';
                toBar.style.display = 'block';
                t_accomodationBar.style.display = 'block';
                
                if(rowIndex == 1){
                    travelOrdertitle.style.display = 'none';
                    accomodationTitle.style.display = 'none';
                    personalDaysTitle.style.display = 'none';
                    
                    fromTitle.style.display = 'block';
                    toTitle.style.display = 'block';
                    t_accomodationTitle.style.display = 'block';
                }
            } else {
                travelOrderRow.style.display = travelOrderCategories.includes(categoryName) ? 'block' : 'none';
                accommodationRow.style.display = 'block';
                personalDaysRow.style.display = 'block';
                accomodationBar.style.display = 'block';
                TABar.style.display = 'block';
                personalDaysBar.style.display = 'block';

                fromRow.style.display = 'none';
                toRow.style.display = 'none';
                fromBar.style.display = 'none';
                toBar.style.display = 'none';
                t_accomodationBar.style.display = 'none';
                if(rowIndex == 1){
                    travelOrdertitle.style.display = 'block';
                    accomodationTitle.style.display = 'block';
                    personalDaysTitle.style.display = 'block';
                    
                    fromTitle.style.display = 'none';
                    toTitle.style.display = 'none';
                    t_accomodationTitle.style.display = 'none';
