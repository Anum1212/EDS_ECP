                                            ...
                                            <div class="card-content collapse show">
                                                <div class="card-body">
                                                    <div id="rowContainer">
                                                        ...
                                                        {{-- */ $categories = \App\Category::where('company_id',$employee->department->businessUnit->company->id)->where('travel_order_suitable', '=', 1)->get(); /* --}}

                                                        <div id="category-form">
                                                            <!-- Label bar (only appears once, not cloned) -->
                                                            <div class="label-bar col-md-12">
                                                                <div class="col-md-2 label">Category<span
                                                                        class="required">*</span></div>
                                                                <div class="col-md-2 label">Date Range (From/To Date &
                                                                    Time)<span class="required">*</span></div>
                                                                <div class="col-md-1 label">From<span
                                                                        class="required">*</span></div>
                                                                <div class="col-md-1 label">To<span
                                                                        class="required">*</span></div>
                                                                <div class="col-md-1 label">Personal Days<span
                                                                        class="required">*</span></div>
                                                                <div class="col-md-1 label">Purpose<span
                                                                        class="required">*</span></div>
                                                                <div class="col-md-2 label">Type of Accommodation<span
                                                                        class="required">*</span></div>
                                                            </div>
                                                                    ...
                                                                    @foreach ($voucher->categoryItems($voucher->id) as $item)
                                                                        ...
                                                                        <div class="form-row">
                                                                            <div class="form-group col-md-2">
                                                                                <select
                                                                                    name="category_{{ $itemCount }}"
                                                                                    id="category_{{ $itemCount }}"
                                                                            ...
                                                                            <div class="form-group col-md-1 mb-2">
                                                                                <input type="text"
                                                                                    class="form-control custom-input"
                                                                                    name="personal_days_{{ $itemCount }}"
                                                                                    id="personal_days_{{ $itemCount }}"
                                                                                    value="{{ $item->description }}"
                                                                                    required>
                                                                            </div>
                                                                            <div class="form-group col-md-1 mb-2">
                                                                                <input type="text"
                                                                                    class="form-control custom-input"
                                                                                    name="purpose_{{ $itemCount }}"
                                                                                    id="purpose_{{ $itemCount }}"
                                                                                    value="{{ $item->description }}"
                                                                                    required>
                                                                            </div>
                                                                            <div class="form-group col-md-3 mb-2">
                                                                                <select class="select2 form-control"
                                                                                    name="accomodation_food_{{ $itemCount }}"
                                                                                    required>
                                                                                    <option></option>
                                                                                    <option class="Others"
                                                                                        value="Own Accomodation">Own
                                                                                        Accomodation</option>
                                                                                    <option class="Others"
                                                                                        value="Accomodation by Host">
                                                                                        Accomodation by Host</option>
                                                                                    <option class="Others"
                                                                                        value="Both Accomodation & Food by Host">
                                                                                        Both Accomodation & Food by Host
                                                                                    </option>
                                                                                    <option class="Local_DA_Air"
                                                                                        value="1"
                                                                                        style="display: none;">
                                                                                        Yes</option>
                                                                                    <option class="Local_DA_Air"
                                                                            ...
                                                                            <!--        style="display: none;margin-left: 2%;margin-bottom: 2%;">-->
                                                                            <!--</div>-->
                                                                ...
                                                                @else
                                                                    <div class="form-row" id="template-row">
                                                                        ...
                                                                        <div class="form-group col-md-2 mb-2">
                                                                            <input type="text"
                                                                                class="form-control custom-input date-range-picker"
                                                                                name="date_range_1" id="date_range_1"
                                                                                placeholder="YYYY-MM-DD HH:MM - YYYY-MM-DD HH:MM"
                                                                                required>
                                                                        </div>
                                                                        <div class="form-group col-md-1 mb-2">
                                                                            <input type="text"
                                                                                class="form-control custom-input"
                                                                                name="from_1" id="from_1" required>
                                                                        </div>
                                                                        <div class="form-group col-md-1 mb-2">
                                                                            <input type="text"
                                                                                class="form-control custom-input"
                                                                                name="to_1" id="to_1" required>
                                                                        </div>
                                                                        <div class="form-group col-md-1 mb-2">
                                                                            <input type="text"
                                                                                class="form-control custom-input"
                                                                                name="personal_days_1"
                                                                                id="personal_days_1" value="0"
                                                                                required>
                                                                        </div>
                                                                        <div class="form-group col-md-1 mb-2">
                                                                            <input type="text"
                                                                                class="form-control custom-input"
                                                                                name="purpose_1" id="purpose_1" required>
                                                                        </div>
                                                                        <div class="form-group col-md-2 mb-2"
                                                                            id="accomodation_food_bar_1">
                                                                            <select class="form-control select-custom"
                                                                                name="accomodation_food_1"
                                                                                style="height: 50%;">
                                                                                <option></option>
                                                                                <option class="Others"
                                                                                    value="Own Accomodation">Own
...
@section('footer')
    ...
    <script>
        function toggleOptions(selectElement) {
            ...
            const accommodationSelect = document.querySelector('select[name="accomodation_food_1"]');
            const othersOptions = accommodationSelect.querySelectorAll('option.Others');
            const localDAAirOptions = accommodationSelect.querySelectorAll('option.Local_DA_Air');

            if (optionText === 'Foreign - DA') {
                othersOptions.forEach(option => option.style.display = 'block');
                localDAAirOptions.forEach(option => option.style.display = 'none');
            } else {
                othersOptions.forEach(option => option.style.display = 'none');
                localDAAirOptions.forEach(option => option.style.display = 'block');
            }
        }
    </script>
    <script>
        ...
        $('body').on('change', 'select.voucherCategory', function(evt) {
            ...
            if ($("[data-parent='" + element_id + "']").length) {
                ...
                if ($('#' + category).length) {
                    ...
                    $.ajax({
                        url: "{{ URL::to('voucher/category/form/display') }}/" + "misc" + "/parent/" +
            ...
            $.ajax({
                url: "{{ URL::to('item/add') }}/" + itemCount + "/parent/" + element_id + '/id/' +
                    categoryID,
                method: "GET",
                data: {
                    type: "{!! $type !!}"
