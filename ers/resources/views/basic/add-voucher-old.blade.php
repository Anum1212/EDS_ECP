                                    ...
                                    <div class="card">
                                        ...
                                        <div class="card-content collapse show">
                                            ...
                                            $categories = \App\Category::where('company_id', $employee->department->businessUnit->company->id)
                                                ->whereNotIn('category_name', $excludedCategoryNames)
                                                ->get(); 
                                            /*--}}

                                                    {{--*/ $travel_orders = \App\Category::where('company_id',$employee->department->businessUnit->company->id)->get(); /*--}}
                                                        ...
                                                        <div id="form-rows">
                                                            @if(isset($voucher))
                                                                @foreach($voucher->categoryItems($voucher->id) as $item)
                                                                    ...
                                                                    <div class="form-row travel-order-row" id="travel-order-row-{{$itemCount}}" style="display: none;">
                                                                        <div class="form-group col-md-2">
                                                                            <select name="travel_order_{{$itemCount}}" class="form-control custom-input" style="
                                                                            height: 35%;
                                                                        ">
                                                            ...
                                                            @else
                                                                <div class="form-row" id="template-row">
                                                                    ...
                                                                    <div class="form-group col-md-2 mb-2">
                                                                        <input type="date" class="form-control custom-input" name="date_1" id="date_1" min="{{date('Y-m-d', strtotime(date('Y-m-d').' - 3 months'))}}" value="{{date('Y-m-d')}}" required>
                                                                    </div>
                                                                    <div class="form-group col-md-3 mb-2">
                                                                    ...
                                                                    <div class="form-group col-md-2 mb-2">
                                                                        <select class="form-control select-custom" name="receipt_provided_1" required style="height: 50%;" onchange="toggleAttachmentIcon(this)">
                                                                ...
                                                                <!-- Travel Order dropdown for specific categories -->
                                                                <div class="form-row travel-order-row" id="travel-order-row-1" style="display: none;">
                                                                    <div class="form-group col-md-2">
                                                                        <select name="travel_order_1" class="form-control custom-input" style="
                                                                        height: 35%;
                                                                    ">
                                                                            @foreach($employee->approvedUnusedTravelOrders as $travelOrder)
                                                                            <option value="{{$travelOrder->id}}">
...
@section('footer')
    ...
    <script>
        function toggleAttachmentIcon(selectElement) {
            const selectedValue = selectElement.value;
            const rowIndex = selectElement.name.split('_')[1];
            const attachmentIcon = document.getElementById(`attachment-icon-${rowIndex}`);

            if (selectedValue === "1") {
                attachmentIcon.style.display = "flex";
            } else {
