            ...
            <div class="content-body">
                ...
                <section id="description" class="card  mr-3">
                    <div class="card-header">
                        <h4 class="card-title" style=" font-size: 30px;">{{ $panelHeading }} </h4>
                    </div>
                    <div class="card-body p-4">
                        ...
                        <div class="card-body">
                            {{-- for employees --}}
                            @if ($userType == 'employee' && $messBooking->status == 'Draft')
                                ...
                                {{-- for approvers --}}
                            @elseif($userType == 'approver' && ($messBooking->status == 'Submitted' || $messBooking->status == 'Pending'))
                                ...
                                <tbody>
                                    ...
                                    @if ($messBooking->status != 'Draft')
                                            <tr>
                                                ...
                                                <td>
                                                    @if (isset($messBooking->approver_id))
                                                            @if ($messBooking->status == 'Approved')
                                                                Approved by
                                                                {{ $employee->employee_number == $messBooking->approver_id ? 'Self' : $employee->employee_name }}
                                                            @elseif ($messBooking->status == 'Rejected')
