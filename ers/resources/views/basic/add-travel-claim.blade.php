...
@section('header')
    ...
    <link rel="stylesheet" type="text/css" href="{{ asset('app-assets/css/custom/add-travel-claim.css') }}">
@endsection
...
@section('footer')
    ...
    <script>
        ...
        var travelOrders = {!! json_encode($approvedUnusedTravelOrders, JSON_HEX_TAG | JSON_HEX_AMP | JSON_HEX_APOS | JSON_HEX_QUOT) !!}
        ...
        var dateInputHtml =
            `<div class="form-group col-md-2 mb-2"><input type="date" class="form-control" name="date_" min="{{ date('Y-m-d', strtotime(date('Y-m-d') . ' - 3 months')) }}"></div>`;
