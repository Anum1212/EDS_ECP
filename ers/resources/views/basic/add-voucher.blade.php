                                    ...
                                    <div class="col-md-9 order-md-1 w-100 overflow-auto">
                                        <table class="table">
                                            <tbody>
                                                ...
                                                <!--                            <select name="cost_center" id="cost_center" class="form-control custom-input" style="height: 50%;">-->
...
<script>
      ...
      function validateForm() {
        ...
        let categoryRequiresAttachment = false;
    
        for (let i = 1; i <= itemCount; i++) {
          const categorySelect = document.getElementById(`category_${i}`);
          if (!categorySelect) continue;
    
          const selectedOption = categorySelect.options[categorySelect.selectedIndex];
          if (!selectedOption) continue;
    
          const selectedCategoryText = selectedOption.text;
    
          if (selectedCategoryText === "Local - Transport" || selectedCategoryText === "Local - Hotel Stay" || selectedCategoryText === "Meal - (During Official Travel)" || selectedCategoryText === "Local - Toll tax / Parking charges / E-Tag" || selectedCategoryText === "Misc" || selectedCategoryText === "Courier") {
            categoryRequiresAttachment = true;
            break; 
          }
        }
    
        if (employeeCompanyName === "Tripack Films Limited" && categoryRequiresAttachment) {
