...
<div class="content-body">
    <section id="form-control-repeater">
        <form action="{{ URL::to($storingURL) }}" method="post" id="voucher-form" enctype="multipart/form-data">
            ...
            <input type="hidden" name="claimType" id="claimType" value="Medical">
                                    ...
                                    <div class="col-md-9 order-md-1 w-100 overflow-auto">
                                        <table class="table">
                                            <tbody>
                                                ...
                                                <tr>
                                                    <td class="text-right"><strong>Remaining OPD Limit </strong></td>
                                                    <td>{{number_format($entitlements->total_limit - $entitlements->consumed_limit)}} PKR</td>
                                        ...
                                        <div class="card-content collapse show">
                                            <div class="card-body">
                                                <div id="rowContainer">
                                                    ...
                                                    {{--*/ $categories = \App\Category::where('company_id', $employee->department->businessUnit->company->id)->where('category_name', 'LIKE', 'Medical%')->get(); /*--}}
                                                    {{-- {{$categories}} --}}
                                                    <div id="category-form">
                                                        ...
                                                        <div class="label-bar col-md-12">
                                                            ...
                                                            <div class="col-md-1 label">Claim Type<span class="required">*</span></div>
                                                            <div class="col-md-2 label">OPD Claim Type<span class="required">*</span></div>
                                                            <div class="col-md-1 label">Receipt #<span class="required">*</span></div>
                                                            <!--<div class="col-md-2 label">Description<span class="required">*</span></div>-->
                                                            <div class="col-md-1 label">Amount Paid<span class="required">*</span></div>
                                                            <div class="col-md-1 label">Receipt Provided<span class="required">*</span></div>
                                                        </div>
                                                        ...
                                                        <div id="form-rows">
                                                                ...
                                                                @foreach($voucher->categoryItems($voucher->id) as $item)
                                                                    ...
                                                                    <div class="form-row">
                                                                        ...
                                                                        <div class="form-group col-md-1 mb-2">
                                                                            <select class="form-control select-custom" name="medical_claim_type_{{$itemCount}}" required style="height: 50%;">
                                                                                <option {{$item->medical_claim_type == "Self" ? 'selected' : ''}} value="Self">Self</option>
                                                                                <option {{$item->medical_claim_type == "Spouse" ? 'selected' : ''}} value="Spouse">Spouse</option>
                                                                                <option {{$item->medical_claim_type == "Child" ? 'selected' : ''}} value="Child">Child</option>
                                                                            </select>
                                                                        </div>
                                                                        <div class="form-group col-md-2 mb-2">
                                                                            <select class="form-control select-custom" name="opd_claim_type_{{$itemCount}}" required style="height: 50%;">
                                                                                <option {{$item->opd_claim_type == "Consultation" ? 'selected' : ''}} value="consultation">Consultation</option>
                                                                                <option {{$item->opd_claim_type == "Lab" ? 'selected' : ''}} value="lab">Lab</option>
                                                                                <option {{$item->opd_claim_type == "Medicines" ? 'selected' : ''}} value="medicines">Medicines</option>
                                                                                <option {{$item->opd_claim_type == "Dental" ? 'selected' : ''}} value="Dental">Dental</option>
                                                                                <option {{$item->opd_claim_type == "Optical" ? 'selected' : ''}} value="Optical">Optical</option>
                                                                            </select>
                                                                        </div>
                                                                        <div class="form-group col-md-1 mb-2">
                                                            ...
                                                            @else
                                                                <div class="form-row" id="template-row">
                                                                    ...
                                                                    <div class="form-group col-md-1 mb-2">
                                                                        <select class="form-control select-custom" name="medical_claim_type_1" required style="height: 50%;">
                                                                        ...
                                                                        <div class="form-group col-md-2 mb-2">
                                                                            <select class="form-control select-custom" name="opd_claim_type_1" required style="height: 50%;">
                                                                    ...
                                                                    <!--<div class="form-group col-md-2 mb-2">-->
                                                                    <!--    <input type="text" class="form-control custom-input" name="description_1" id="description_1" required>-->
                                                                    <!--</div>-->
                                                                    <div class="form-group col-md-1 mb-2">
