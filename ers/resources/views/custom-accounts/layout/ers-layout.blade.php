{{--*/ $inProcessVouchers = \App\Voucher::whereIn('status', ['In Process'])->whereNull('is_travel_order')->count(); /*--}}
{{--*/ $inProcessTravelOrders = \App\Voucher::whereIn('status', ['In Process'])->where('is_travel_order', '=', 1)->count(); /*--}}
{{--*/ $documentsTransitVouchers = \App\Voucher::whereIn('status', ['Approved - Documents in transit'])->count(); /*--}}
