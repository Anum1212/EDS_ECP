<div class="card" id="{{$categoryName}}" data-parent="{{$parent}}">
    <div class="card-header card-head-inverse bg-secondary">
        <a data-action="collapse"><h4 class="card-title text-white">Local - Toll Tax / Parking charges / E-Tag <span class="badge badge bg-white text-secondary badge-pill mr-2"></span></h4></a>
