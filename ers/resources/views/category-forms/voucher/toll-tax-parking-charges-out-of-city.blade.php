<div class="card" id="{{$categoryName}}" data-parent="{{$parent}}">
    <div class="card-header card-head-inverse bg-secondary">
        <a data-action="collapse"><h4 class="card-title text-white">Local - Toll Tax / Parking charges / E-Tag (out of city) <span class="badge badge bg-white text-secondary badge-pill mr-2"></span></h4></a>
        ...
        <div class="card-body">
            ...
            @else
                <div class="form-row">
                    <div class="form-group col-md-2 mb-2">
                        <label>Date of Travel</label>
                        <input type="date" class="form-control" name="date_{{$itemCount}}" min="{{date('Y-m-d', strtotime(date('Y-m-d').' - 3 months'))}}" id="date_{{$itemCount}}">
                    </div>
                    <div class="form-group col-md-2 mb-2">
                        <label>From Location</label>
                        <input type="text" class="form-control" data-id='225' name="from_{{$itemCount}}" id="from_{{$itemCount}}">
                    </div>
                    <div class="form-group col-md-2 mb-2">
                        <label>To Location</label>
                        <input type="text" class="form-control" data-id='225' name="to_{{$itemCount}}" id="to_{{$itemCount}}">
                    </div>
                    <div class="form-group col-md-2 mb-2" hidden>
                        <label>Amount</label>
                    ...
                    <div class="form-group col-md-2 mb-2">
                        <label>Amount paid</label>
                        <input type="text" class="form-control" value="0" name="amount_paid_{{$itemCount}}" id="amount_paid_{{$itemCount}}">
                    </div>
                    <div class="form-group col-md-2 mb-2">
                        <label>Receipt Provided</label>
                        <select class="select2 form-control" name="receipt_provided_{{$itemCount}}" required>
