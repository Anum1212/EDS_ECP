                ...
                @foreach($voucher->categoryItems($voucher->id,$categoryID) as $item)
                    ...
                    <div class="form-row">
                        ...
                        <div class="form-group col-md-2 mb-2">
                            ...
                            <input type="text" class="form-control" value="{{$item->kms}}" name="kms_{{$itemCount}}" id="kms_{{$itemCount}}" required>
                        </div>
                        <div class="form-group col-md-4 mb-2">
                            <label>Travel Order</label>
                            <select class="select2 form-control" name="travel_order_{{$itemCount}}" required>
                                <option></option>
                                @foreach($employee->approvedUnusedTravelOrders as $travelOrder)
                                    <option value="{{$travelOrder->id}}">
                                        ...
                                        @foreach($travelOrder->VoucherItems as $item)
                                            ...
                                            @elseif(isset($item->from) && isset($item->to))
