<div class="card" id="{{$categoryName}}" data-parent="{{$parent}}">
    <div class="card-header card-head-inverse bg-secondary">
        <a data-action="collapse"><h4 class="card-title text-white"> Employee Amenities-Sales office <span class="badge badge bg-white text-secondary badge-pill mr-2"></span></h4></a>
