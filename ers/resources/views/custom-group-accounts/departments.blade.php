{{--*/ $departments = \App\Department::with('businessUnit', 'businessUnit.company')->whereHas('businessUnit.company', function($query) use ($employee){$query->where('companies.group_name', '=', $employee->department->businessUnit->company->group_name);})->get(); /*--}}
